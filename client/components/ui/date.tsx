...
type CalendarFieldProps = Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, 'value' | 'onChange'> & {
    value?: Date;
    onChange: (date?: Date) => void;
};

export function CalendarField({value, onChange, className, ...props}: CalendarFieldProps) {
